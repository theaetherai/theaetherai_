  ...
  return (
    <div
      ...
      className={cn(
        ...
        'flex hover:bg-secondary/30 cursor-pointer transition-all duration-300 items-center gap-2 justify-between min-w-[250px] py-4 px-4 rounded-lg sleek-card bg-card'
      )}
    >
        ...
        <div className="flex flex-col gap-[1px]">
          {onRename ? (
            <Input
              ...
              autoFocus
              placeholder={name}
              className="sleek-input border-none text-base w-full outline-none text-foreground bg-transparent p-0"
              ref={inputRef}
            />
          ) : (
            <p
      ...
      <FolderDuotone className="text-primary" />
    </div>
  )
}
